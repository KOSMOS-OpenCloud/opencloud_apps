    ...
    afterAllSetup(client) {
        ...
        const unsubscribePageloadResolved = router.subscribe("onResolved", (onResolvedArgs) => {
          ...
          if (resolvedMatch && resolvedMatch.routeId !== routeMatch?.routeId) {
            ...
            pageloadSpan.setAttributes({
              ...
              [attributes.URL_TEMPLATE]: resolvedMatch.routeId,
      ...
      if (instrumentNavigation) {
        ...
        const applyRouteMatch = (span, match, toLocation, fallbackName) => {
          ...
          span.setAttribute(core.SEMANTIC_ATTRIBUTE_SENTRY_SOURCE, match ? "route" : "url");
          span.setAttributes({
            [attributes.URL_TEMPLATE]: match?.routeId,
            ...locationToSpanUrlAttributes(router, toLocation),
