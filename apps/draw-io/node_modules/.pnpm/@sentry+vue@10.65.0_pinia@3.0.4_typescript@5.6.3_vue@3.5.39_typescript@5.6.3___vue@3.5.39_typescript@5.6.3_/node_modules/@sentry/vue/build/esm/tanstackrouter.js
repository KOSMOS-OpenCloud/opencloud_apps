...
import { URL_TEMPLATE, URL_PATH_PARAMETER_KEY, PARAMS_KEY, URL_FULL, URL_PATH } from '@sentry/conventions/attributes';
...
function routeMatchToParamSpanAttributes(match) {
  ...
  Object.entries(match.params).forEach(([key, value]) => {
    ...
    paramAttributes[PARAMS_KEY.replace("<key>", key)] = value;
  });
